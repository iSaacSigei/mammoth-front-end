...
export default function AdminDashboard({ admin }) {
  ...
  const showToastMessage = () => {
    toast("Your price quotation has been sent to our client via email!", {
      position: toast.POSITION.TOP_CENTER,
      className: "toast-message",
    });
  };
  useEffect(() => {
    fetch(`https://mammoth-deploy-2-production.up.railway.app/admins/${admin.id}/lands/${id}`)
      .then((r) => r.json())
      .then((data) => {
        console.log(data);
        setLands(data);
        ...
        <div className="hidden lg:fixed lg:inset-y-0 lg:z-50 lg:flex lg:w-72 lg:flex-col">
          ...
          <div className="flex grow flex-col gap-y-5 overflow-y-auto bg-gray-900 px-6 pb-4">
            <div className="flex h-16 shrink-0 items-center">
              ...
              <p className="text-xl text-white pl-8">Mammoth</p>
            </div>
            <nav className="flex flex-1 flex-col">
              <ul role="list" className="flex flex-1 flex-col gap-y-7">
                <li>
                  ...
                  <div className="mt-10 border-t border-gray-200 pt-10">
                    ...
                    >
                      ...
                      {processing ? (
                            ...
                            disabled
                            type="button"
                            class="w-1/2 pl-6 text-white bg-indigo-600 hover:bg-indigo-700 focus:ring-4 font-medium rounded-lg text-sm px-3 py-3 text-center mr-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 inline-flex items-center "
                          >
                            <svg
                              aria-hidden="true"
                              role="status"
                        ...
                        <button
                          type="submit"
                          className="flex w-1/4 items-center rounded-md border border-transparent bg-indigo-600 px-3 py-1.5 text-base font-medium text-white hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 focus:ring-offset-gray-50"
                        >
                          Submit
                        </button>
                      )}
